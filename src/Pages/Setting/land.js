      ...
      <Layout>
        ...
        <div className="setting-landing">
          <div className="setting-header">
            <h1>Setting</h1>
            <Link to="/home" className="setting-colse">
              &times;
            </Link>
          </div>
          <div className="landing-content">
              ...
              <Link to="/setting/general" style={{ color: "white" }}>
                <div className="tab-content">
                  ...
                  <div className="content">
                    Currency conversion, primary currency, language, blockies
                    identicon
                  </div>
                </div>
            ...
            <div className="tab">
              <Link to="/setting/advanced" style={{ color: "white" }}>
                <div className="tab-content">
                  ...
                  <div className="content">
                    Access developer features, download State Logs, Reset
                    Account, setup test networks and custom RPC
                  </div>
                </div>
                <div className="tab-caret">
                  <img src={arrow} />
            ...
            <div className="tab">
              <Link to="/setting/alerts" style={{ color: "white" }}>
                <div className="tab-content">
                  ...
                  <div className="content">Enable or disable each alert</div>
                </div>
                <div className="tab-caret">
                  <img src={arrow} />
                </div>
            ...
            <div className="tab">
              <Link to="/setting/experimental" style={{ color: "white" }}>
                <div className="tab-content">
                  <h2 className="title">Experimental</h2>
                  <div className="content">Token detection & more</div>
                </div>
                <div className="tab-caret">
                  <img src={arrow} />
                </div>
