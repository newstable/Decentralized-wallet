      ...
      <Layout>
        ...
        <div className="connect-wallet">
          <div className="card">
            ...
            <p>Select a hardware wallet you'd like to use with MetaMask.</p>
            <div className="main-content">
              <div className="main-item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 197.4 48.6"
                >
                  <g fill="#ffffff">
            ...
            <div style={{ marginBottom: "20px", padding: "3px" }}>
              <button className="connect-button">Next</button>
              <Link to="/home" className="connect-button">
                Cancel
              </Link>
            </div>
          </div>
