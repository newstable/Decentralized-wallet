...
import Detail from "./Pages/Setting/Details";
...
import NewContract from "./Pages/Setting/newContact";
import AssetTransaction from "./components/Home/Asset-Transaction";
  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route exact path="/setting" component={General}></Route>
        ...
        <Route path="/home/add-network" component={AddAccount}></Route>
        <Route path="/home/lock" component={Lock}></Route>
        <Route path="/home/transaction/" component={AssetTransaction}></Route>
        ...
        <Route path="/setting/details" component={Detail}></Route>
        <Route path="/setting/addContact" component={NewContract}></Route>
